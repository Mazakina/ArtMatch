...
export default function Profile({ profile, social, createdAt }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <Text
            ...
            fontSize="42px"
          >
            {capitalizeFirstLetter(profile.usuario)}
          </Text>
        </Flex>
        ...
        <Box mt={{ base: "0", lg: "40px" }} zIndex="5" w="100%">
          <Flex
            ...
            borderRadius="5"
          >
            <Text m="20px auto auto">
              {profile.biografia ||
                capitalizeFirstLetter(profile.usuario) +
                  ` ainda não nos contou muito sobre ele. `}
            </Text>
            <Flex w={{ base: "100%", lg: "fit-content" }}>
              <Box
                w={{ base: "100%", lg: "80px" }}
                h="100%"
                m={{ base: "auto 0", lg: "auto  1rem auto 40px" }}
              >
                <Flex
                  w="100%"
                  h={{ base: "70px", lg: "100%" }}
                ...
                >
                  ...
                  >
                    ...
                    <SocialLink
                      icon={FaArtstation}
                      link={"https://www.artstation.com/" + social.artstation}
                    ...
                    >
                      <Image
                        overflow={"hidden"}
                        filter={social.instagram ? "" : "grayscale(100%);"}
                    ...
                    <Flex>
                      <Tooltip
                        placement="top"
                        label={social.number || "não adicionado"}
                      >
      ...
      <Flex alignItems="center" margin="0 auto 2rem" flexDir="column">
      ...
      <Flex alignItems="flex-start" margin="0 auto 100px" flexDir="column">
...
export async function getServerSideProps(context) {
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/api/_lib/userSettings/getUserProfile`,
    {
      method: "post",
      headers: {

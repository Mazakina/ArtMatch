  ...
  return (
    ...
    >
      <Box p="1rem" m="40px 0" pb="40px" bg="#121212">
        <Text mb="8px" ml="2rem" fontSize="24px">
          Habilidades
        </Text>
      ...
      <Flex p="1rem" m="1rem 0" pb="40px" bg="#121212" flexDir={"column"}>
        <Text ml="3rem" fontSize="24px">
          Endereço
        </Text>
        <Division width={"100%"} bg="#323232" />
        <Flex alignItems="center" mb=".5rem" justifyContent="center">
          <Text m="0 1rem 0 auto">{endereco || "Não registrado"}</Text>{" "}
          <Icon
            fontSize={"1.5rem"}
            mr="auto"
            color="#FFF"
      ...
      <Flex m="1rem auto" flexDir={"row"}>
        <Text mb="8px" textAlign={"center"} fontSize="24px">
          Membro Desde: <br />
          {memberSince}
        </Text>
      </Flex>

...
export default function PerfilSec({settingOpt,userSettings,user}:PerfilSec){
    ...
    <>
      <FormControl
        ...
        <Flex
          ...
          flexDir='column'
          id='left-nav'>   
          <Flex  flexDir={{base:'column',md:'row'}} align={{base:'flex-start',md:'center'}}>
            ...
            <Input
              ...
              onChange={(e)=>{if(regex.test(e.target.value)){setUsuario(e.target.value)}}}
              value={usuario}/>
          </Flex>
          <Flex  flexDir={{base:'column',md:'row'}} align={{base:'flex-start',md:'center'}} mt='1rem' >
            <Text w={{base:'fit-content',md:'20%'}} maxWidth='130px'>
              Biografia
            </Text>
          ...
          <Flex  mt='1rem' w='100%'  flexDir={{base:'column',md:'row'}} align={{base:'flex-start',md:'center'}}>
            <Flex width={{base:'100%',md:'80%'}}  justify='center' flexDir='column'>
              <Flex  flexDir={{base:'column',md:'row'}} align={{base:'flex-start',md:'center'}}>
                <Text width='130px'>
                  Cidade
                </Text>

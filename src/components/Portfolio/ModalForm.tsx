...
export default function ModalForm({
  ...
  const isDisabled = !isNewFile || formPart === false
  ...
  async function handleOnSubmit(event) {
    ...
    if (isNewFile === true) {
      ...
      Api({
        ...
        const newArray = postsCollection.map((post) => {
            ...
            <Flex h="100%" flexDir={{ base: 'column', lg: 'row' }}>
              ...
              >
                <FormControl as={Flex} justify="center" position="absolute">
                  ...
                  />
                  {!newImage && (
                    <Text m="0 1rem" zIndex={2}>
                      Arraste uma Imagem ou clique aqui para escolher
                    </Text>
                  )}
                </FormControl>
              ...
              {formPart && (
                <Flex ml="16px" maxWidth="420px" width="100%" flexDir="column">
                  ...
                  <Text w="90%" color="#BEBEBE" mt="14px" fontSize="12px">
                  ...
                  <Box mt="10px" width="280px" height="280px">
                    ...
                    >
                      {newImage && (
                        <Image
                          alt="preview da imagem recortada"
                          ref={imgRef}
                          src={newImage}
                        />
                      )}

...
const SideBarComponentDrawer = React.memo(function SideBar({
  albums,
  onOpenNewPost,
  onAlbumDrop,
  setIsNewFile,
  ...
  function deleteAlbum(album) {
    try {
      ...
      const newAlbumArray = albumsCollection.filter(
        ...
        <DrawerBody zIndex={10}>
          <Flex minWidth="240px" height="98%" id="left-nav" flexDir="column">
            ...
            <Tooltip
              placement="auto"
              bg="#4e4e4e"
              label="Arraste aqui para deletar"
            >
              <Button
                id="new-post"
              ...
              >
                ...
                <Icon as={BsPlusSquare} fontSize="1.5rem" />
              </Button>
            </Tooltip>
          </Flex>
        </DrawerBody>

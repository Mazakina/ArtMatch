...
export const  SearchComponent = React.memo<any>(({searchItems=[],isActive=''})=> {
  ...
  return(
    ...
    {searchItems?
      searchItems.map((item:itemProps) =>{
        return(
          <ListItem as={Link} href={`./posts/${item.id}`} cursor='pointer !important' mb='.3rem'  borderBottom='1px solid #c5c5c5'pb={'.3rem'} display={'flex'} alignItems={'center'} fontSize='1rem'>

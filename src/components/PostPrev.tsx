...
export default function PostPrev ({post}){
  ...
  return(
    <Flex as={Link} href={`/posts/${post.id}`}  mt='.5rem' border='1px solid #0000000'  key={post.id}   > 
      <Flex  w={{base:'33.33%',md:'25%',lg:'20%',xl:'12.5'}} maxWidth={'260px'} justify='center' position='relative'>
